...
Ajaxified.TimePicker.prototype = {
    ...
    _appendPopupButton: function() {
        ...
        Sys.UI.DomElement.setLocation(this._btnPopUp, textbox_location.x + textbox.offsetWidth + 5, textbox_location.y + ((textbox.offsetHeight - 20) / 2));
    ...
    _addTimePicker: function() {
        ...
        title = NewElement('span', { 'innerHTML': 'Select Time' });
